...
export default function Bookmarks() {
  ...
  const [showBookmarkButtons, setShowBookmarkButtons] = React.useState([null, null, null, null]);   // 1.Create 2.Delete 3.Rename 4.Move
  ...
  useEffect(() => {
    ...
    fetch('https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/folder?user_id='+location.state.userId)
    .then(res => res.json())
    .then(data => {
        setFolders(data);
    })
  ...
  const handleFolderClick = (e, folderKey) => {
    ...
    setShowBookmarkButtons([true, false, false, false])
  ...
  const handleBookmarkClick = (e, bookmarkKey, folderKey) => {
    ...
    if(folderKey !== "root") {
        ...
        setShowBookmarkButtons([true, true, true, true]);
    }
    else {
        setShowFolderButtons([true, false, false]);
        setShowBookmarkButtons([false, true, true, true]);
    }
    setSelectedFolderId(folderKey);
  ...
  const createFolder = (e) => {
    ...
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/newfolder?folder_name="+newName+"&user_id="+location.state.userId)
    .then(res => {
      tempFolders[res] = {
        "bookmarks" : {},
        "name" : newName,
  ...
  const createBookmark = () => {
    ...
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/bookmark?folder_id=root&bookmark_name="+newName+"&url="+newLink+"&user_id="+location.state.userId)
    .then(res => {
      let tempFolders = folders;
      tempFolders["root"]["bookmarks"][res] = {
        "name" : newName,
        "url": newLink,
      }
  ...
  const addBookmarkToFolder = (e) => {
    ...
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/bookmark?folder_id="+selectedFolderId+"&bookmark_name="+newName+"&url="+newLink+"&user_id="+location.state.userId)
    .then(res => {
      let tempFolders = folders;
      tempFolders[selectedFolderId]["bookmarks"][res] = {
        "name" : newName,
        "url": newLink,
      }
      setFolders(tempFolders);    
  ...
  const deleteFolder = (e) => {
    ...
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/folder/"+selectedFolderId+"?user_id="+location.state.userId)
    .then(res => {
      console.log(res)
    }).catch(error=> {
      console.log(error)
    ...
    setShowBookmarkButtons([false, false, false ,false]);
    setShowFolderButtons([true, false, false]);      
  ...
  const deleteBookmark = () => {
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/bookmark/"+selectedBookmarkId+"?folder_id="+selectedFolderId+"&user_id="+location.state.userId)
    .then(res => {
      console.log(res);
      let tempFolders = folders
  ...
  const renameFolder = () => {    
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev//updatefolder?folder_name="+newName+"&folder_id="+selectedFolderId+"&user_id="+location.state.userId)
    .then(res => {
  ...
  const editBookmark = () => {
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/updatebookmark?folder_id="+selectedFolderId+"&bookmark_id="+selectedBookmarkId+"&bookmark_name="+newName+"&url="+newLink+"&user_id="+location.state.userId)
    .then(res => {
      console.log(res)
    }).catch(error=> {
      console.log(error)
  ...
  const moveBookmark = () => {
    ...
    Axios.put("https://foz9ysieii.execute-api.us-east-1.amazonaws.com/dev/bookmark?folder_id="+selectedRenameFolderId+"&bookmark_name="+clipboard["name"]+"&url="+clipboard["url"]+"&user_id="+location.state.userId)
    .then(res => {
      let tempFolders = folders;
    ...
    <div>
        ...
        <div className={classes.mainDiv}>
            ...
            <div className={classes.actionsDiv}>
                ...
                <Button color = "primary" className = {classes.actionButton} variant= "outlined" onClick = {() => {setShowCreateBookmarkModal(true); setCreateOrAddFlag(0)}}>Create bookmark</Button>
